const en = {
  main: {
    start: {
      title: 'We’re all stuck.',
      subtitle: '🎲 Let’s having a good time! 🎲',
      paragraph:
        'Containment Game has the ambition to allow everyone to enjoy with their friends no matter where they are, despite the lockdown! Today, only Code Names has been implemented, but everything is open source!',
      help: 'I want to help!',
